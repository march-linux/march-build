...
make_customize_root_image() {
	...
	find ${work_dir}/root-image/usr/share/locale/* ! -name locale.alias | xargs -0 rm -rf
	find ${work_dir}/root-image/usr/share/ -name doc -type d | xargs -0 rm -rf
	find ${work_dir}/root-image/usr/share/ -name examples -type d | xargs -0 rm -rf
