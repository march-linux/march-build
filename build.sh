...
make_customize_root_image() {
	...
	find ${work_dir}/root-image/usr/share/i18n/locales/* ! -name en_US ! -name en_GB ! -name i18n ! -name iso14651_t1 ! -name iso14651_t1_common ! -name translit_neutral | xargs rm -rf
