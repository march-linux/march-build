...
make_customize_root_image() {
	...
	find ${work_dir}/root-image/usr/share/locale/* ! -name locale.alias -delete
	find ${work_dir}/root-image/usr/share/ -name doc -type d -delete
	find ${work_dir}/root-image/usr/share/ -name examples -type d -delete
